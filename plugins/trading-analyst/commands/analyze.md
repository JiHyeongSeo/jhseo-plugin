...
**모델: `claude-haiku-4-5-20251001`** (빠른 단순 분석용)
...
**모델: `claude-haiku-4-5-20251001`** (구조화된 논거 작성용)
...
**모델: `claude-haiku-4-5-20251001`** (구조화된 반박 논거용)
...
**모델: `claude-sonnet-4-6`** (양측 종합·판단 필요)
...
**모델: `claude-opus-4-7`** (최종 투자 결정 — 가장 높은 추론 품질 필요)
